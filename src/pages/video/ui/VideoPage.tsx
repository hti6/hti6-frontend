...
export const VideoPage = () => {
    const tableConfig = {
        ...
        rowClassName: "hover:bg-[#F7F7F8] cursor-pointer transition-colors duration-200",
        ...
        <TableWidget<Camera>
            ...
            renderEmptyState={() => (
                <div className="text-center py-12">
                    ...
                    <p className="text-[#93979F] mt-2">Нажмите + чтобы добавить новую камеру</p>
                </div>
            )}
